...
DROP TABLE IF EXISTS process_steps CASCADE; -- Add CASCADE if there are dependent tables like use_cases

CREATE TABLE process_steps (
id SERIAL PRIMARY KEY,
bi_id VARCHAR(255) UNIQUE NOT NULL,
name VARCHAR(255) NOT NULL,
area_id INTEGER NOT NULL, -- Assuming 'areas' table exists and has an 'id' column
...
FOREIGN KEY (area_id) REFERENCES areas(id) -- Ensure foreign key is defined
);
