...
if __name__ == "__main__":
    ...
    with app.app_context():
        ...
        # 3. Get the import service function via dependency injection
        import_func = import_database_from_json_service()

        # 4. Call the import service function
        try:
            result = import_func(json_data, clear_existing_data=True)
